...
This work presents a novel OMR scheme, InstantOMR, based on a hybrid use of TFHE homomorphic operations and regular RLWE operations. InstantOMR is specifically optimized for low latency and high parallelizability. In paticular, our implementation using Primus-fhe library (and our estimation using TFHE-rs library) demonstrates that InstantOMR has the following advantages:
